...
class VSSM(nn.Module):
    def __init__(
        ...
        gmlp=False,
        # =========================
        drop_path_rate=0.5, # 0.6
        patch_norm=True, 
        norm_layer="LN2D", # "BN", "LN2D" , "LN"
...
#     def __init__(self, 
#                  depths=[2, 2, 15], dims=128, drop_path_rate=0.6,
#                  patch_size=4, in_chans=4, num_classes=1000,
...
class Backbone_VSSM(VSSM):
    def __init__(self, out_indices=(0, 1, 2), pretrained=None, norm_layer="ln", **kwargs): # out_indices=(0, 1, 2, 3)
...
def vmamba_base(channel_first=True):
    return VSSM(
        depths=[2, 2, 2], dims=128, drop_path_rate=0.3, # [2, 2, 15]
        patch_size=4, in_chans=4, num_classes=1000,
        ssm_d_state=1, ssm_ratio=2.0, ssm_dt_rank="auto", ssm_act_layer="silu",
        ssm_conv=3, ssm_conv_bias=False, ssm_drop_rate=0.0, 
        ssm_init="v0", forward_type="v05_noz", 
